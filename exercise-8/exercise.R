...
# 2004-2014?
publication_most_winners <- select(filter(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014 == max(Pulitzer.Prize.Winners.and.Finalists..2004.2014)), Newspaper)
...
filter(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014 >= 5) %>%
  summarize(change = Daily.Circulation..2013 - Daily.Circulation..2004)
